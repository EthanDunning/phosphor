...
export const CORRUPTION_BYTES_PER_HIT = 1;
...
export const PLAYER_MAX_HEALTH = 175;
...
export const BOSS_SHIELD_HP = 256;
export const BOSS_FIREWALL_SPEED = 22;
export const BOSS_FIREWALL_HALF_THICKNESS = 2.2;
export const BOSS_FIREWALL_FADE_RATE = 1.6;
export const BOSS_FIREWALL_BURST_COUNT = 5;
export const BOSS_FIREWALL_COOLDOWN_MS = 60000;
export const BOSS_POWERUP_INTERVAL_MS = 13000;
export const BOSS_SHIELDED_ENEMY_CAP = 6;
export const BOSS_UNSHIELDED_ENEMY_CAP = 10;
